...
def search():
    ...
    if (saletype != None and propertytype != None):
        filter_query = Properties.query.filter(Properties.for_type == saletype, Properties.gen_property_type == propertytype)
        is_filter = True
    ...
    if (saletype != None and propertytype != None and price != None):
        filter_query = Properties.query.filter(Properties.for_type == saletype , Properties.gen_property_type == propertytype, Properties.price >= price)
        is_filter = True
        
    if (saletype != None and propertytype != None and price != None and beds != None):
        filter_query = Properties.query.filter(Properties.for_type == saletype , Properties.gen_property_type == propertytype, Properties.price >= price, Properties.num_bed >= beds)
        is_filter = True

    if (saletype != None and propertytype != None and price != None and beds != None and baths != None):
        filter_query = Properties.query.filter(Properties.for_type == saletype , Properties.gen_property_type == propertytype, Properties.price >= price, Properties.num_bed >= beds, Properties.num_bath >= baths)
        is_filter = True

    if (price != None and propertytype != None):
        filter_query = Properties.query.filter(Properties.price >= price, Properties.gen_property_type == propertytype)
        is_filter = True
    ...
    if (price != None and propertytype != None and beds != None and baths != None):
        filter_query = Properties.query.filter(Properties.price >= price, Properties.gen_property_type == propertytype, Properties.num_bed >= beds, Properties.num_bath >= baths)
        is_filter = True

    if (price != None and propertytype != None and beds != None):
        filter_query = Properties.query.filter(Properties.price >= price, Properties.gen_property_type == propertytype, Properties.num_bed >= beds)
        is_filter = True

    if (price != None and propertytype != None and baths != None):
        filter_query = Properties.query.filter(Properties.price >= price, Properties.gen_property_type == propertytype, Properties.num_bath >= baths)
        is_filter = True

    if (propertytype != None and beds != None):
        filter_query = Properties.query.filter(Properties.gen_property_type == propertytype, Properties.num_bed >= beds)
        is_filter = True

    if (propertytype != None and baths != None):
        filter_query = Properties.query.filter(Properties.gen_property_type == propertytype, Properties.num_bath >= baths)
        is_filter = True

    if (propertytype != None and beds != None and baths != None):
        filter_query = Properties.query.filter(Properties.gen_property_type == propertytype, Properties.num_bed >= beds, Properties.num_bath >= baths)
        is_filter = True
