...
def search():
    ...
    #     images.append(convert_picture(properties[i].image))
    #     # properties[i].image = images[i] # postedproperties breaks image type but not here
    ...
    #         print(str(instance))
    #         print('property image: ' + str(instance.image))
...
#     dataurl = base64.b64encode(image_file.getvalue()).decode('ascii')
